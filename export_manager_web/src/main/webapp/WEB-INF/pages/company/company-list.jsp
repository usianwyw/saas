        ...
        <div class="box box-primary">
            ...
            <div class="box-footer">
                ...
                <div class="box-tools pull-right">
                    <ul class="pagination">
                        <li>
                            <a href="/company/list.do?page=1" aria-label="Previous">首页</a>
                        </li>
                        <li><a href="/company/list.do?page=${page.prePage}">上一页</a></li>
                        <li><a href="/company/list.do?page=1">1</a></li>
                        <li><a href="/company/list.do?page=2">2</a></li>
                        <li><a href="/company/list.do?page=3">3</a></li>
                        <li><a href="/company/list.do?page=4">4</a></li>
                        <li><a href="/company/list.do?page=5">5</a></li>
                        <li><a href="/company/list.do?page=${page.nextPage}">下一页</a></li>
                        <li>
                            <a href="/company/list.do?page=${page.pages}" aria-label="Next">尾页</a>
                        </li>
                    </ul>
                </div>
