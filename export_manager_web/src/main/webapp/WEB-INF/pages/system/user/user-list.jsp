        ...
        <div class="box box-primary">
            ...
            <div class="box-footer">
                ...
                <div class="box-tools pull-right">
                    <ul class="pagination">
                        <li>
                            <a href="/system/user/list.do?page=1" aria-label="Previous">首页</a>
                        </li>
                        <li><a href="/system/user/list.do?page=${pageInfo.prePage}">上一页</a></li>
                        <c:forEach begin="1" end="${pageInfo.pages}" var="i">
                            <li><a href="/system/user/list.do?page=${i}">${i}</a></li>
                        </c:forEach>
                        <li><a href="/system/user/list.do?page=${pageInfo.nextPage}">下一页</a></li>
                        <li>
                            <a href="/system/user/list.do?page=${pageInfo.pages}" aria-label="Next">尾页</a>
                        </li>
                    </ul>
                </div>
